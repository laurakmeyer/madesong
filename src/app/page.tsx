...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#f5f0e8] text-[#1a1a1a]">
      ...
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 py-5 bg-[#f5f0e8]/90 backdrop-blur-md border-b border-black/5">
      ...
      <section className="py-20 md:py-32 px-6 md:px-20 bg-[#fdf9f3]">
      ...
      <section className="py-20 md:py-32 px-6 md:px-20 bg-[#f5f0e8]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
      ...
      <section className="relative h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center px-8 md:px-24">
          <div className="max-w-xl">
            ...
            <a href="#erstellen"
              className="inline-flex items-center gap-2 bg-[#fdf9f3] text-black font-bold px-7 py-3.5 rounded-full hover:bg-zinc-100 transition-all hover:scale-105">
      ...
      {/* Form */}
      <section id="erstellen" className="bg-[#fdf9f3] py-24 px-6">
      ...
      {/* How it works */}
      <section id="so-funktionierts" className="py-24 px-6 bg-[#f5f0e8]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={num} className="bg-[#fdf9f3] rounded-3xl p-8 shadow-sm border border-black/5">
      ...
      {/* Stats */}
      <section className="py-16 px-6 bg-[#fdf9f3] border-y border-black/5">
      ...
      {/* Pricing */}
      <section id="preise" className="py-24 px-6 bg-[#f5f0e8]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={name} className={`rounded-3xl p-8 border flex flex-col ${highlight ? "bg-black text-white border-black" : "bg-[#fdf9f3] border-black/8"}`}>
                ...
                <a href="#erstellen"
                  className={`mt-8 text-center text-sm font-bold py-3.5 rounded-full transition-all hover:scale-105 ${highlight ? "bg-[#fdf9f3] text-black hover:bg-zinc-100" : "bg-black text-white hover:bg-zinc-800"}`}>
                  Jetzt starten
                </a>
              </div>
            ))}
      ...
      {/* Final CTA */}
      <section className="py-28 px-6 bg-[#fdf9f3] text-center">
      ...
      {/* Footer */}
      <footer className="border-t border-black/8 py-10 px-6 bg-[#f5f0e8]">
